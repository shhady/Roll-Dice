  ...
  return (
    <div className="main">
       ...
       <div className="header">
        ...
        { this.state.showMessage && <div className="popup" style={{color: "black", height: 300, borderRadius:"20%", fontSize: "30px",position: 'fixed', top:"150px" }}><img src="https://c.tenor.com/VpQP6Yhbc8gAAAAM/will-ferrell-amy-poehler.gif" alt="gif"></img><h1>Nice! 12 Points Added</h1><button onClick={this.backtoPlayAfterSix}>continue</button></div>}
        </div>
