...
class Main extends React.Component {
    ...
    this.setState({currentScore1: this.state.currentScore1 + rand1+ rand2}, ()=>{
       ...
       if(this.state.currentScore1 > 100){
           this.setState({player2name: "Winner Winner", currentScore1: 0, currentScore2: 0, totalScore2: 0,totalScore1: 0})
       }else if(this.state.currentScore1 === 100){
        this.setState({player1name: "Winner Winner", currentScore1: 0, currentScore2: 0, totalScore2: 0,totalScore1: 0})
       }
    }) 
    }  
