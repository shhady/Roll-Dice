...
class Main extends React.Component {
    ...
    state = {player1name:"player1", player2name:"player2", player1: true, player2: false, totalScore1: 0, currentScore1:0,totalScore2: 0, currentScore2:0, imgNum1: 0, imgNum2:0, winnerShow: true, maxScore: 100} 
...
//-----------------------------------
    ...
    this.setState({currentScore1: this.state.currentScore1 + rand1+ rand2}, ()=>{
       ...
       if(this.state.currentScore1 > this.state.maxScore){
        ...
        this.setState({player1name: "player 1 is the Winner he reached 100",player2name:"", currentScore1: 0, currentScore2: 0, totalScore2: 0,totalScore1: 0, winnerShow: false})
       }
    }) 
    }  
    ...
    this.setState({currentScore2: this.state.currentScore2 + rand1+ rand2}, ()=>{
        ...
        if(this.state.currentScore2 > this.state.maxScore){
            ...
            this.setState({player2name: "player 2 is the Winner he reached 100",player1name: "", currentScore1: 0, currentScore2: 0, totalScore2: 0,totalScore1: 0,  winnerShow: false})
        }
    })
  ...
  return (
    <div className="main">
        ...
        <label style={{color: "white"}}>MAX SCORE</label>
        <input type = 'number' className="input-button" onChange={this.onInputChange}></input>
        </div>
